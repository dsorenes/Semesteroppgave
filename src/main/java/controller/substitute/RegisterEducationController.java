...
import model.data.substitute.register.education.Education;
import model.data.substitute.register.education.EducationLevel;
import model.data.substitute.register.education.Subject;
...
public class RegisterEducationController implements Initializable {
    ...
    private void NextPage(ActionEvent event) {
        try {
            ...
            AnchorPane pane = FXMLLoader.load(getClass().getResource("/view/substitute/RegisterWorkExperienceView.fxml"));
